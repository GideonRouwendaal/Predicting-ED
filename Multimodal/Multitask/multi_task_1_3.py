import argparse
from Dataset.dataset_2D_multi_task_1_3 import prepare_fold_dataset, calculate_mean_std
...
def outer_cv(args):
    ...
    for fold_idx in tqdm(range(args.n_outer_folds)):
        ...
        save_dir = f"Final/Models/Multi_Task/multiple_2D_slices_1_3/{cf['model_type']}/{pretrained}/fold_{fold_idx}"
