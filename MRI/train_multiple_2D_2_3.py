import argparse
from Dataset.dataset_2D_2_3 import prepare_fold_dataset, calculate_mean_std
...
def outer_cv(args):
    ...
    for fold_idx in tqdm(range(args.n_outer_folds)):
        ...
        best_params_file = f"Final/Models/single_slice/{args.model_type}/{pretrained}/fold_{fold_idx}/metrics_and_params.txt"
        ...
        save_dir = f"Final/Models/multiple_2D_slices_2_3/{cf['model_type']}/{pretrained}/fold_{fold_idx}"
